const limits = {
  ...
  PUBLIC_LIMIT_MAX_DELAY_MS: 30 * 1000,
  PUBLIC_LIMIT_MAX_RATE: 25_000,
  ...
  MAX_CONCURRENT_PROCESSCOMMITS: 2048, // this influences # of http requests, so lower can be faster
  ...
  MOIZED_FETCH_MAX_AGE_MS: 30 * 1000, // default memoization when using fetch()
